...
| OBL-28 | No detection for silently deleted CI guards | 2026-07-28 | `scripts/verify-workflow-structure.py` rewritten and wired to `scripts/test-verify-workflow-structure.py`. **10 of 10 mutations caught**, against 3 of 10 for the removed version — including a missing base ref now exiting 2 rather than reporting success. |
